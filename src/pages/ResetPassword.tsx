...
const ResetPassword = () => {
  ...
  return (
    <div className="flex min-h-screen w-full max-w-[480px] mx-auto overflow-x-hidden flex-col items-center justify-center bg-mesh-light dark:bg-mesh-dark bg-auth-pattern bg-grain px-4">
